...
/**
 * Created by sonsch94 on 2017-09-16.
 */
...
public class ReceiveCallActivity extends AppCompatActivity {
    ...
    //////////////// Connect Part ///////////////////////
    private static final String TAG = "Receive_Call_Activity";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        NicknameTV = (TextView)findViewById(R.id.ReceiveCallName);
        profileImage = (ImageView)findViewById(R.id.ProfileImage);

        NicknameTV.setText(nickname);
        Glide.with(this).load("http://vnschat.vps.phps.kr/profile_image/" + friendId + ".png")
